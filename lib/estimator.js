...
const DIFImpact = data => {
  ...
  return Math.trunc(IBRTImpact(data) * avgDailyIncomePopulation * avgDailyIncomeInUSD / convertToDays(data));
};
...
const DIF_SI = data => {
  ...
  return Math.trunc(IBRT_SI(data) * avgDailyIncomePopulation * avgDailyIncomeInUSD / convertToDays(data));
};
